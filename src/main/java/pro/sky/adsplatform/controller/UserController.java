...
public class UserController {
    ...
    @PostMapping("/addUser")
    public ResponseEntity<CreateUserDto> addUserUsingPOST(@Parameter(in = ParameterIn.DEFAULT, description = "user", required=true, schema=@Schema()) @Valid @RequestBody CreateUserDto body) {
